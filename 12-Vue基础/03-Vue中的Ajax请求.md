...
vue.js 文件向windows对象爆露了 vue 这个关键字，''vue-resource.js'向vue身上挂载了 'this.$http'这个属性。于是，我们可以直接写"this.$http.get"或者''this.$http.post'或者''this.$http.jsonp'来调用
